...
-- Design Ports Information
-- Y_L	=>  Location: PIN_U7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- D1	=>  Location: PIN_U6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- S0	=>  Location: PIN_Y2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- D0_L	=>  Location: PIN_W6,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF lab2_2inMUX IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \inst2~0_combout\ = (\S0~input_o\ & (\D1~input_o\)) # (!\S0~input_o\ & ((!\D0_L~input_o\)))
