...
-- Q[3]	=>  Location: PIN_A14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Q[2]	=>  Location: PIN_AB16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Q[1]	=>  Location: PIN_D15,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- START	=>  Location: PIN_W10,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF lab3_2bit_cnt IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \inst6|inst24~combout\ : std_logic;
SIGNAL \inst6|inst8~combout\ : std_logic;
SIGNAL \inst6|inst1~combout\ : std_logic;
SIGNAL \inst6|ALT_INV_inst24~combout\ : std_logic;
...
\inst6|ALT_INV_inst24~combout\ <= NOT \inst6|inst24~combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst6|ALT_INV_inst24~combout\,
	devoe => ww_devoe,
	o => \A_L~output_o\);
...
\inst6|inst24\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst6|inst24~combout\ = (\inst1~q\) # (!\inst~q\)
...
PORT MAP (
	dataa => \inst1~q\,
	datac => \inst~q\,
	combout => \inst6|inst24~combout\);

-- Location: LCCOMB_X69_Y53_N12
\inst6|inst8\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst6|inst8~combout\ = (\inst~q\) # (!\inst1~q\)
...
-- Equation(s):
-- \inst6|inst1~combout\ = (\inst~q\) # (\inst1~q\)
