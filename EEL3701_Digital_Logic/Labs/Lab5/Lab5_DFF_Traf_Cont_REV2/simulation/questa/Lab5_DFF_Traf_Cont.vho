...
SIGNAL \inst|D[3]~7_combout\ : std_logic;
SIGNAL \inst|D[3]~8_combout\ : std_logic;
...
\inst|D[3]~7\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst|D[3]~7_combout\ = (\inst4~q\ & (!\inst1~q\ & \inst5~q\)) # (!\inst4~q\ & (\inst1~q\ & !\inst5~q\))
...
PORT MAP (
	...
	datac => \inst1~q\,
	datad => \inst5~q\,
	combout => \inst|D[3]~7_combout\);

-- Location: LCCOMB_X23_Y1_N14
\inst|D[3]~8\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst|D[3]~8_combout\ = (\inst|D[3]~7_combout\ & ((\inst6~q\ & ((\inst5~q\) # (\EV~input_o\))) # (!\inst6~q\ & (!\inst5~q\))))
...
PORT MAP (
	...
	datab => \inst5~q\,
	datac => \EV~input_o\,
	datad => \inst|D[3]~7_combout\,
	combout => \inst|D[3]~8_combout\);
...
-- Equation(s):
-- \inst|D[0]~0_combout\ = (!\inst1~q\ & ((\inst5~q\) # ((!\EV~input_o\ & !\CW_L~input_o\))))
...
-- Equation(s):
-- \inst|D[0]~1_combout\ = (\EV~input_o\ & (\inst1~q\ & ((!\inst5~q\) # (!\inst6~q\)))) # (!\EV~input_o\ & (!\inst6~q\ & ((!\inst5~q\) # (!\inst1~q\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0100000111010001",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \inst6~q\,
...
-- Equation(s):
-- \inst|D[0]~2_combout\ = (\inst4~q\ & (\inst|D[0]~0_combout\ & (!\inst6~q\))) # (!\inst4~q\ & (((\inst|D[0]~1_combout\))))
...
-- Equation(s):
-- \inst|D[1]~3_combout\ = (\EV~input_o\ & (!\inst1~q\ & ((!\inst5~q\) # (!\inst4~q\))))
...
-- Equation(s):
-- \inst|D[2]~6_combout\ = (\inst|D[2]~5_combout\) # ((!\CW_L~input_o\ & (!\inst5~q\ & \inst4~q\)))
...
-- Equation(s):
-- \inst|Green~0_combout\ = (\inst1~q\) # ((\inst4~q\ & ((\inst5~q\) # (\inst6~q\))))
...
-- Equation(s):
-- \inst|Yellow~0_combout\ = (\inst5~q\ & (\EV~input_o\ $ (!\inst6~q\))) # (!\inst5~q\ & (!\EV~input_o\ & \inst6~q\))
...
-- Equation(s):
-- \inst|Red~0_combout\ = (\inst4~q\ & (!\inst1~q\ & (\inst5~q\ & \inst6~q\))) # (!\inst4~q\ & (\inst1~q\ & (!\inst5~q\)))
