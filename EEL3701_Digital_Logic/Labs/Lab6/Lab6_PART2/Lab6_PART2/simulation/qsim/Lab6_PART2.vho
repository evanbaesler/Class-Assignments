...
\inst3|altsyncram_component|auto_generated|ram_block1a8_PORTAADDR_bus\ <= (\inst1|sub|110~q\ & \inst1|sub|99~q\ & \inst1|sub|87~q\ & \inst1|sub|9~q\);
...
GENERIC MAP (
	...
	logical_ram_name => "Lab6_ROM:inst3|altsyncram:altsyncram_component|altsyncram_imr3:auto_generated|ALTSYNCRAM",
	operation_mode => "rom",
...
PORT MAP (
	...
	datac => \inst3|altsyncram_component|auto_generated|ram_block1a10\,
...
-- Equation(s):
-- \inst1|sub|75~0_combout\ = (\inst17|inst4~q\ & ((\inst17|inst2~q\ & ((\inst3|altsyncram_component|auto_generated|ram_block1a8~portadataout\))) # (!\inst17|inst2~q\ & (!\inst1|sub|9~q\)))) # (!\inst17|inst4~q\ & (\inst17|inst2~q\ $ ((\inst1|sub|9~q\))))
...
-- Equation(s):
-- \inst|inst9|10~0_combout\ = (\inst17|inst|MSA[0]~1_combout\ & ((\inst|inst5~q\) # ((\inst17|inst|MSA\(1))))) # (!\inst17|inst|MSA[0]~1_combout\ & (((!\inst17|inst|MSA\(1) & \inst3|altsyncram_component|auto_generated|ram_block1a9\))))
...
-- Equation(s):
-- \inst|inst11|9~0_combout\ = (\inst17|inst|MSB[0]~2_combout\ & ((\inst|inst3~q\) # ((\inst17|inst|MSB[1]~0_combout\)))) # (!\inst17|inst|MSB[0]~2_combout\ & (((\inst3|altsyncram_component|auto_generated|ram_block1a10\ & !\inst17|inst|MSB[1]~0_combout\))))
