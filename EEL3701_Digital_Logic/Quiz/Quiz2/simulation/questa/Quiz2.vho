...
-- Design Ports Information
-- X	=>  Location: PIN_AA15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- C	=>  Location: PIN_W8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- B	=>  Location: PIN_W7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF Quiz2 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \inst|9~0_combout\ = (\C~input_o\) # ((\A~input_o\ & ((\B~input_o\))) # (!\A~input_o\ & (\D~input_o\)))
